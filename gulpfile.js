...
gulp.task("js-libs", function () {
  return gulp
    .src(["node_modules/slick-carousel/slick/slick.js", "app/js/plugins/*.js"])
...
gulp.task("watch", function () {
  ...
  gulp.watch("app/js/plugins/*.js", gulp.parallel("js-libs"));
});

gulp.task("build", gulp.series("clean", "export"));

gulp.task("default", gulp.parallel("css", "scss", "js-libs", "script", "browser-sync", "watch"));
